const calculateInterestRate = (loanAmount: number, montlhyPayments: number, months: number): number => {
...
const findInterestRate = (searchTarget: number, months: number, starting: number, ending: number): number => {
